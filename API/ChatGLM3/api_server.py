...
# set LLM path
MODEL_PATH = os.environ.get('MODEL_PATH', '/usr/local/TFBOYS/gc/model/chatglm3-6b-32k')
TOKENIZER_PATH = os.environ.get("TOKENIZER_PATH", MODEL_PATH)

# set Embedding Model path
EMBEDDING_PATH = os.environ.get('EMBEDDING_PATH', '/usr/local/TFBOYS/gc/model/text2vec-large-chinese')
